...
<div class="py-4 bg-success">
            <div class="row px-3"> 
                <h3 class="ml-5 mb-2 text-light">Anda Login Sebagai Admin / Petugas</h3>
...
<div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
    <div class="card card0 border-0">
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="img/login2.jpeg" class="image"> </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                  <form class="user" method="post" action="cek_login2.php">
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input class="mb-4" type="password" name="password" placeholder="Masukan password"> </div>
                    <br>
        ...
        <div class="py-4">
            <div class="row px-3"> <small class="mx-auto mb-2">Copyright &copy; by euis khoirunnisa 2021</small>
